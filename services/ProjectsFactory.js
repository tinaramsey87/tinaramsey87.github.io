portfolio.factory("ProjectsFactory", function ProjectsFactory() {
  ...
  factory.projects = [
    ...
    { title: "Email Client", info: "This is an email client where users can 'send' email, with support for multiple user inboxes.", tech: "EmberJS", link: "https://tinaramsey87.github.io/email_client_js", image: "./img/email.png", id: 4 },
    { title: "Undead Journal", info: "A blogging app that lets users sign in and create posts, as well as comment on posts.", tech: "Ruby on Rails", link: "https://quiet-lake-9545.herokuapp.com", image: "./img/journal.jpg", id: 5 }
  ];
